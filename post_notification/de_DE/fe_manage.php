...
function post_notification_profile_manage($param){
	...
	$navbar = '<a href="'. post_notification_fe_make_link('info') . '">Info</a> &middot; ' .
		...
		'<a href="'. post_notification_fe_make_link('post_cat') . '">Abonnierte Kategorien</a> &middot; ' .
		'<a href="'. post_notification_fe_make_link('com_cat') . '">Abonnierte Kommentare (Kategorie)</a> &middot; ' .
		'<a href="'. post_notification_fe_make_link('com_post') . '">Abonnierte Kommentare (Post)</a>';
